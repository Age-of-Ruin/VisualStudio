...
# VERSION [Date of last change: 2013-Oct-5]
#
# PURPOSE: To calculate the number of days since Dec. 31, 1900 at 
# 11:59:59 (i.e. Jan. 1 is 0) till a specified date after cede starting point
...
DATES = ( "1900-03-01", "2013-1-1", "2013-Feb-28", "2013-Oct-17", "9999-12-31", "10000-Dec-32")            
...
def abbreviateMonths() :
    ...
    for month in FULL_MONTHS :
        ...
        count += 1
        strCount = str(count)
        extraStrCount = "0" + strCount
        
        monthAbrv.append(month[:3])
        numOfMonths.append(strCount)
        numMonthsplus0.append(extraStrCount)
